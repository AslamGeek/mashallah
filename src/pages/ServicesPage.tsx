  ...
  return (
    <>
      <PageSeo
        ...
        description="Complete welding and iron fabrication services in Proddatur: main gates, window safety grills, staircase railings, sheet metal doors, tank stands, and on-site repairs by Abdul Sattar."
      />
