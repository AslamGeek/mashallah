          ...
          {homepageServices.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* Action Row */}
                <div className="pt-4 mt-4 border-t border-light-border flex flex-col gap-2.5">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    >
                      <span>{isServiceExpanded ? 'Less' : 'Details'}</span>
                      {isServiceExpanded ? (
                  ...
                  <a
                    ...
                    className="w-full inline-flex items-center justify-center text-xs font-bold text-emerald-800 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300/80 px-3.5 py-2.5 rounded-xl transition-colors min-h-[40px] text-center"
                  >
                    <WhatsAppIcon className="w-4 h-4 mr-1.5 shrink-0 text-emerald-600" />
