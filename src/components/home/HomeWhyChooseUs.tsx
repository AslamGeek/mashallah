...
import { ShieldCheck, Ruler, Clock, Coins, Award, ThumbsUp } from 'lucide-react';
...
export const HomeWhyChooseUs: React.FC = () => {
  ...
  return (
    <section id="trust-pillars" className="py-16 sm:py-20 bg-warm-tint text-dark-text border-b border-light-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-12 sm:mb-14">
          ...
          <p className="text-base sm:text-lg text-stone-600 leading-relaxed">
            Local property owners trust our Auto Nagar workshop for dependable metal fabrication that stands firm against time, weather, and wear.
          </p>
        </div>
