  ...
  return (
    <section id="services" className={`${className} bg-light-bg text-dark-text border-b border-light-border`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3 min-w-0 gap-2">
                  ...
                  <span className="text-[11px] font-bold uppercase tracking-wider text-stone-500 bg-stone-100 px-2.5 py-1 rounded-md border border-light-border shrink-0 text-center">
                    {service.category}
                  </span>
                </div>
                ...
                >
                  <span className="text-xl font-bold text-dark-text group-hover/title:text-copper transition-colors leading-snug break-words flex-1 min-w-0">
                    {service.title}
                  </span>
                ...
                <p className="text-stone-600 text-sm leading-relaxed mb-4 break-words">
                  {service.description}
                </p>

                {/* Expanded Detailed Information */}
                {isExpanded && (
                  <div className="p-3.5 mb-4 rounded-xl bg-stone-50 border border-light-border space-y-2 text-xs text-stone-700 min-w-0">
                    ...
                    <div className="space-y-1.5 leading-relaxed">
                      <div className="flex items-start space-x-2">
                        ...
                        <span className="break-words"><strong>Quality Metal:</strong> High-grade strong steel chosen for long life and safety.</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <span className="text-copper font-bold">•</span>
                        <span className="break-words"><strong>Rust Protection:</strong> Anti-rust primer coating and clean weather-resistant paint.</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <span className="text-copper font-bold">•</span>
                        <span className="break-words"><strong>Doorstep Service:</strong> Free site measurement, delivery, and welded fitting in Proddatur.</span>
                      </div>
                    </div>
                  </div>
                )}
        ...
        <div className="mt-12 bg-warm-tint rounded-2xl p-6 sm:p-8 text-dark-text shadow-xs border border-light-border flex flex-col md:flex-row items-center justify-between gap-6 min-w-0">
          <div className="space-y-2 text-center md:text-left min-w-0">
            <h4 className="text-xl sm:text-2xl font-extrabold text-dark-text break-words">
              Have a Photo, Sketch, or Custom Size?
            </h4>
            <p className="text-stone-600 text-sm max-w-2xl leading-relaxed break-words">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto shrink-0 inline-flex items-center justify-center px-6 py-3 rounded-xl bg-copper hover:bg-copper-hover text-white font-bold text-sm tracking-wide shadow-xs transition-all active:scale-[0.98] min-h-[44px] text-center"
          >
